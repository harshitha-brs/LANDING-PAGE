...
// random quotes
const quotes = [
  "Never Measure the height of mountain until you reach the top , then you will see how low it was.",
...
const bgURL = [
  "./assets/img/landing-bg-6.png",
  "./assets/img/landong-bg-7.png",
  "./assets/img/landing-bg-8.png",
  "./assets/img/landing-bg-9.png",
  "./assets/img/landing-bg-5.png"
];
